...
/*        visual = new VisualApi.Builder(driver, sauceUsername, sauceAccessKey, DataCenter.US_WEST_1)
                .withBuild("Landing Page Visual Test")
                .withBranch("main")
...
//    ...
    ...
    public void LandingPageTitle (String type, String browser, String version, String os, String device, Method method) throws Exception {
       ...
       driver.get("https://ultimateqa.com/fake-landing-page");
        assertEquals(driver.getTitle(), "Fake landing page - Ultimate QA");
//Uncomment for Visual Testing
//        CheckOptions options = new CheckOptions();
//        options.setCaptureDom(true);
//        options.enableFullPageScreenshots();
//        visual.sauceVisualCheck("Landing Page");
    }
